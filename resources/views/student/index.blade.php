    ...
    <div class="container-fluid mt--7">
        ...
        <div class="row">
            <div class="col">
                ...
                <form action="/search_student" method="GET" class="float-right pl-3">
                                ...
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control p-2" type="search" placeholder="Search" name="search_student" style="border: 1px solid #e8e8e8;">
                                </div>
                            </form> 
                        </div>
                        <!-- Modal -->
